...
document.onload = (function(d3, saveAs, Blob, undefined){
  ...
  // first step: define graphcreator object
  var GraphCreator = function(svg, nodes, edges){
    var thisGraph = this;  // this can be asigned to an object
        thisGraph.idct = 0;   //global
  ...
  GraphCreator.prototype.svgMouseUp = function(){
    ...
    if (state.justScaleTransGraph) {
      ...
      // clicked not dragged from svg         shift click
      var xycoords = d3.mouse(thisGraph.svgG.node()),
          d = {id: thisGraph.idct++, title: 'New State '+thisGraph.idct, x: xycoords[0], y: xycoords[1]};
      thisGraph.nodes.push(d);
      thisGraph.updateGraph();
      // make title of text immediently editable not working
  ...
  // initial node data
  var nodes = [{title: "New Concept", id: 0, x: xLoc-300, y: yLoc+100},
               {title: "New Concept", id: 1, x: xLoc-300, y: yLoc + 300}];
  var edges = [{source: nodes[1], target: nodes[0]}]; // links
